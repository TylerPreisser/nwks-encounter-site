...
NWKS.forms.specs = {
  menAttendee: {
    ...
    fields: [
      ...
      { name: 'entry.1533571593', label: 'Phone Number', type: 'text', required: true, format: 'phone' },
      ...
      { name: 'entry.1664846639', label: 'Contact Phone Number', type: 'text', required: true, format: 'phone' },
  ...
  women: {
    ...
    fields: [
      ...
      { name: 'entry.605524732', label: 'Your Phone Number - Cell Preferred', type: 'text', required: true, format: 'phone' },
      ...
      { name: 'entry.398378885', label: "Contact Person's Phone Number", type: 'text', required: true, format: 'phone' },
