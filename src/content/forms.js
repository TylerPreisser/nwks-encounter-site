...
NWKS.forms.specs = {
  menAttendee: {
    ...
    fields: [
      ...
      { name: 'entry.1408504039', label: 'Launch Location', type: 'radio', required: true,
        options: ['Hays', 'Norton', 'Plainville', 'Hoxie', 'Colby', 'Gove', 'Sterling', 'Wakeeney'] },
      { name: 'entry.795573491', label: 'Shirt Size', type: 'radio', required: true,
        options: ['XS', 'S', 'M', 'L', 'XL', 'XXL', 'XXXL', 'XXXXL'] },
      { name: 'entry.1224445372', label: 'What Church do you attend, if any?', type: 'text', required: true },
      { name: 'entry.875492866', label: 'How many times have you attended a Mens Encounter?', type: 'radio', required: true,
        options: ['This will be my first time!', '1', '2', 'More than 2'] },
      { name: 'entry.1596599000', label: 'Who invited you or how did you hear about Mens Encounter?', type: 'text', required: true },
